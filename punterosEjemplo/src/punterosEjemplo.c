...
int main(void) {
	...
	printf(
			"Muestran el mismo valor por que en la variable puntero a entero (pNumero) guarde la direccion de memoria de numero\n\n\n");

	printf("Dir de de pNumero: %p\n", &pNumero);
	printf(
			"Por que esta direccion es distinta? por que es de la variable pNumero no de la cual apunta\n\n\n");
	...
	*pNumero = 8; //le cambio el CONTENIDO a la variable a la que apunta
	...
	printf("Valor que guarda pNumero: %p\n", pNumero); //pNumero en si almacena una direccion de memoria
	printf(
			"Volvio a cambiar de valor! ahora por la linea 43 guarda la dir de memoria de otroNumero\n\n\n");
	*/
